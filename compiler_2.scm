...
(define arg-get?
  (lambda (param lambda-body)
        (cond ((null? lambda-body) #f)
              ...
              ((and (list? lambda-body) (equal? 'set (car lambda-body)) (equal? `(var ,param) (get-lambda-args lambda-body))) (get? param (get-lambda-body lambda-body)))
              ((list? lambda-body) (ormap (lambda (x) (get? param x)) lambda-body))
             (else #f))         
             ))
